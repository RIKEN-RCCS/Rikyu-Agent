"""Health checks for the RikyuAgent configuration.
...
def check_ssh() -> bool:
    from rikyu_mcp.middleware import run_command
...
def check_docs_index() -> bool:
    ...
    if not chunks_path.exists():
        print(f"{FAIL} docs index: {chunks_path} missing — run: python -m rikyu_mcp.rag.ingest")
        return False
